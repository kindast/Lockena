  ...
  return (
    <div className="px-2 sm:px-6 py-1 sm:py-4 bg-gray-50 dark:bg-gray-900 grow flex  justify-center">
      <div className="w-full md:w-1/2 space-y-6">
        <p className="text-lg sm:text-2xl text-gray-900 dark:text-white font-medium">
          Профиль пользователя
        </p>
        <div className="border border-gray-200 dark:bg-gray-800 dark:border-gray-300 p-3 sm:p-6 rounded-xl bg-white space-y-4">
        ...
        <div className="border border-gray-200 dark:bg-gray-800 dark:border-gray-300 p-3 sm:p-6 rounded-xl bg-white space-y-4">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-2 sm:p-4 flex justify-between items-center rounded-xl">
            <div>
              <p className="font-medium dark:text-gray-300 text-sm sm:text-md">
                Главный пароль
              </p>
            ...
            <Button
              ...
              className="w-60 text-xs sm:text-lg"
            />
          </div>
        </div>
        <div className="border-red-200 dark:border-red-900 border-2 p-3 sm:p-6 rounded-xl bg-white dark:bg-gray-800 space-y-4">
          <div className="rounded-xl bg-red-50 dark:bg-red-950 p-3 sm:p-6 space-y-4">
            ...
            <Button
              ...
              color="red"
              className="sm:w-1/3 bg-red-600 hover:bg-red-700 rounded-xl"
            />
          </div>
        </div>
      </div>
