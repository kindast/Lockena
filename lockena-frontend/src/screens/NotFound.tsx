        ...
        <div className="w-full max-w-lg">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-1 md:p-6 transition-colors duration-300">
            <div className="text-center mb-8">
              <div className="mb-6">
                <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-indigo-600 to-indigo-800 dark:from-indigo-400 dark:to-indigo-600 bg-clip-text text-transparent mb-4">
                  404
                </h2>
                <div className="flex justify-center">
                  <div className="w-24 h-1 bg-gradient-to-r from-indigo-600 to-indigo-800 dark:from-indigo-400 dark:to-indigo-600 rounded-full"></div>
                </div>
              </div>
            ...
            <div className="space-y-2">
              <button
                className="cursor-pointer w-full bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white py-2 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
